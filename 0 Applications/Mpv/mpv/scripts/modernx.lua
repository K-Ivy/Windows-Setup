...
local user_opts = {
    ...
    noxmas = yes,                 -- disable santa hat in December
    ...
    titlefontsize = 21,             -- the font size of the title text
    chapterformat = 'no',           -- chapter print format for seekbar-hover. "no" to disable
    dateformat = "%m-%d-%Y",        -- how dates should be formatted, when read from metadata
    ...
    downloadbutton = false,          -- show download button for web videos
